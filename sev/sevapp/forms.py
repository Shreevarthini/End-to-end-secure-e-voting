...
#from phonenumber_field.formfields import PhoneNumberField    #changed
...
class ElectionForm(forms.ModelForm):
	class Meta():
		...
		widgets = {
			'election_name':forms.TextInput(attrs = {'class':'form-control', 'placeholder':'PR_Selection'}),
		}
...
class VoterForm(forms.ModelForm):
	...
	#phone=PhoneNumberField()  #changed
